...
<html lang="en">
  ...
  <?php
    $sql_view = "select * from blog where id ='$id'";
              ...
              <div class="col-md-8 col-sm-8">
                <div class="mu-blog-content mu-blog-details">
                  ...
                  <article class="mu-news-single">
                    <h2><a href="#"><?php echo $row_view['title']; ?></a></h2>
                    <figure class="mu-news-img">
                      <a href="#"><img src="uploads/<?php echo $row_view['file']; ?>" alt="img"></a>                      
                    </figure>
                    <div class="mu-news-single-content">                      
                      <ul class="mu-meta-nav">
                        <li>By Admin</li>
                        <li>Date: <?php echo $row_view['date']; ?></li>
                      </ul>
                      <p><?php echo $row_view['descr']; ?></p>
                      <blockquote>
      ...
      <div class="row">
        ...
        <div class="mu-footer-area">
          ...
          <div class="mu-footer-copyright">
            <p>Developed by <a rel="nofollow" href="http://www.maxcom.kg/">maxcom</a></p>
          </div>         
        </div>
      </div>
      </div>
